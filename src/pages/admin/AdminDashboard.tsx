...
{/* Quick Admin Controls */}
      <section className="panel card" style={{ display: "grid", gap: 10 }}>
        ...
        <div className="row" style={{ gap: 10, flexWrap: "wrap" }}>
          ...
          <button
            type="button"
            className={dashUI.showHomeTogglesBtn ? "btn btn-ghost" : "btn btn-primary"}
            onClick={() => setDashUI((p) => ({ ...p, showHomeTogglesBtn: !p.showHomeTogglesBtn }))}
            style={{ fontWeight: 950 }}
            title="Show/hide the Home Page Toggles button on this dashboard"
          >
            {dashUI.showHomeTogglesBtn ? "Hide Home Toggles Button" : "Show Home Toggles Button"}
          </button>
